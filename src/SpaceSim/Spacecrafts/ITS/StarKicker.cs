...
{
    class StarKicker : SpaceCraftBase
    {
        public override string CraftName { get { return "StarKicker"; } }
        public override string CommandFileName { get { return "StarKicker.xml"; } }

        public override double DryMass { get { return 39750; } }
        public override double Width { get { return 9; } }
        public override double Height { get { return 36; } }
        ...
        public StarKicker(string craftDirectory, DVector2 position, DVector2 velocity, double payloadMass = 0, double propellantMass = 1160000)
            : base(craftDirectory, position, velocity, payloadMass, propellantMass, null)
        {
            StageOffset = new DVector2(4, -15);
            ...
            string texturePath = "Its/StarKicker.png";
