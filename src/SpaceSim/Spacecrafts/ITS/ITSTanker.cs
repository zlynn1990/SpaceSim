...
{
    class ITSTanker : SpaceCraftBase
    {
        public override string CraftName { get { return "ITS Tanker"; } }
        public override string CommandFileName { get { return "itsTanker.xml"; } }

        public override double DryMass { get { return 90000 + payloadMass; } }
        ...
        public ITSTanker(string craftDirectory, DVector2 position, DVector2 velocity, double payloadMass, double propellantMass = 1769010)
