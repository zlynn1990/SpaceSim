...
{
    class EuropaClipper : SpaceCraftBase
    {
        ...
        private SLS5mFairing _leftFairing;
        private SLS5mFairing _rightFairing;
        private bool _deployedFairings;
        DateTime timestamp = DateTime.Now;

        public EuropaClipper(string craftDirectory, DVector2 position, DVector2 velocity, double payloadMass)
        ...
        public void AttachFairings(SLS5mFairing leftFairing, SLS5mFairing rightFairing)
        {
