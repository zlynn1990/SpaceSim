...
{
    sealed class F9S2C : SpaceCraftBase
    {
        ...
        PartyBalloon _drogueChute;
        // Parachute _parachute;
        Skid[] _skids;
        DateTime timestamp = DateTime.Now;

        public F9S2C(string craftDirectory, DVector2 position, DVector2 velocity, double stageOffset, double propellantMass = 103500)
            : base(craftDirectory, position, velocity, 0, propellantMass, "Falcon/9/S2.png")
        {
            StageOffset = new DVector2(0, stageOffset);

            _drogueChute = new PartyBalloon(this, new DVector2(-2.5, 5));
