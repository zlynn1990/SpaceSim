...
{
    sealed class DIVHS2 : SpaceCraftBase
    {
        public override string CraftName { get { return "DIVH S2"; } }
        public override string CommandFileName { get { return "DIVHS2.xml"; } }
        ...
        public DIVHS2(string craftDirectory, DVector2 position, DVector2 velocity, double zOffset = 9)
