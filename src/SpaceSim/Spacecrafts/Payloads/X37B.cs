...
{
    class X37B : SpaceCraftBase
    {
        public override string CraftName { get { return _craftName; } }
        public override string CommandFileName { get { return "X37B.xml"; } }

        public override double Width { get { return 4.55; } }
        public override double Height { get { return 8.92; } }
        ...
        public X37B(string craftDirectory, DVector2 position, DVector2 velocity, double payloadMass)
            : base(craftDirectory, position, velocity, payloadMass, 0, "Satellites/X37B.png")
        {
